...
namespace WI.objects
{
    ...
    '.'
        ...
        public static string RemoveHtmlTags(string text)
        {
            ...
            Regex regexJava2 = new Regex("(\\[.*?\\]\\s*)+", RegexOptions.Singleline);
            Regex regexScript = new Regex("(<script.*?</script>\\s*)+", RegexOptions.Singleline);
            //Regex regexComments2 = new Regex("(\\.*?\n\\s *)+ ", RegexOptions.Singleline);
            Regex regexComments = new Regex("(/\\*.*?\\*/\\s*)+ ", RegexOptions.Singleline);
            ...
            Regex regex10 = new Regex("\\&", RegexOptions.Singleline);
            Regex regex11 = new Regex("\\/", RegexOptions.Singleline);
            Regex regex12 = new Regex(@"\\", RegexOptions.Singleline);
            Regex regex13 = new Regex("\\>", RegexOptions.Singleline);
            Regex regex14 = new Regex(@"\<", RegexOptions.Singleline);

            noCode = regexScript.Replace(noCode, " ");
            noCode = regexJava.Replace(noCode, " ");
            noCode = regexJava2.Replace(noCode, " ");
            //noCode = regexComments2.Replace(noCode, " ");
            noCode = regexHtlm.Replace(noCode, " ");
            noCode = regex1.Replace(noCode, " ");
            noCode = regex2.Replace(noCode, " ");
            noCode = regex3.Replace(noCode, " ");
            noCode = regex4.Replace(noCode, " ");
            noCode = regex5.Replace(noCode, " ");
            noCode = regex6.Replace(noCode, " ");
            noCode = regex7.Replace(noCode, " ");
            noCode = regex8.Replace(noCode, " ");
            noCode = regex9.Replace(noCode, " ");
            noCode = regex10.Replace(noCode, " ");
            noCode = regexComments.Replace(noCode, " ");
            noCode = regex11.Replace(noCode, " ");
            noCode = regex12.Replace(noCode, " ");
            noCode = regex13.Replace(noCode, " ");
            noCode = regex14.Replace(noCode, " ");
            noCode = regexQuotation.Replace(noCode, " ");
